...
def userinfo(request):
    ...
    #response=requests.get('https://api.covid19api.com/countries').json()
    return render(request,'admin/User_info.html',
                  {'userlist':userlist})
...
def manageproperties(request):
    return render(request,'admin/Manage_properties_Available.html')

def managerental(request):
    return render(request,'admin/Manage_Rental_properties.html')
